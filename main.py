...
import src.multilabel as multilabel
...
## Bag of words
X_train_mybag, X_val_mybag, X_test_mybag = transform.bag_of_words(X_train, X_val, X_test, words_counts)
## TF-IDF
X_train_tfidf, X_val_tfidf, X_test_tfidf, tfidf_vocab, tfidf_reversed_vocab = transform.initialize_tfidf_vectorizer(X_train, X_val, X_test)

# Train model
## Init multilabel classifier
mlb, y_train, y_val = multilabel.init_multilabel_classifier(y_train, y_val, tags_counts)
## Bag of words
y_val_predicted_labels_mybag, y_val_predicted_scores_mybag = multilabel.multilabel_bag_of_words(X_train_mybag, y_train, X_val_mybag)
## TF-IDF
y_val_predicted_labels_tfidf, y_val_predicted_scores_tfidf = multilabel.multilabel_tfidf(X_train_tfidf, y_train, X_val_tfidf)
